...
export const PALACE = {
  ...
  兄弟: { short: '兄弟姊妹', area: '兄弟姊妹與換帖的朋友', long: '兄弟姊妹、麻吉、平輩之間的往來',
  ...
  子女: { short: '小孩與作品', area: '小孩、晚輩，還有你親手做出來的東西', long: '小孩、學生、下屬，以及你親手做出來的作品',
  ...
  遷移: { short: '出外運', area: '出遠門與換環境', long: '出遠門、搬家、換工作環境、跟外面的人打交道',
    good: '往外走會有好事，出門、換環境、拓展都順', bad: '在外面容易碰釘子，出遠門或變動要多留心' },
  僕役: { short: '朋友同事', area: '朋友、同事與合作的人', long: '你的人脈圈、共事的人、合夥人',
